...
## [2.0.0](https://github.com/AnoRebel/licensing/compare/licensing-v1.0.0...licensing-v2.0.0) (2026-08-21)
...
* add license-key rotation and extract a template hierarchy tree ([76d6c61](https://github.com/AnoRebel/licensing/commit/76d6c612c4672a6bd98da11d0ca62f144c5aaba4))
...
* **admin:** show template defaults in the issue-from-template dialog ([0249e89](https://github.com/AnoRebel/licensing/commit/0249e897e86d0c18caa6cbb8e19537f0c605a262))
...
* **sdk:** add LIC2, a PASETO v4.public token format ([2ac4cb2](https://github.com/AnoRebel/licensing/commit/2ac4cb29d8eaa0193cabeb30fa888e7cdf6acb53))
...
* **sdk:** make the token envelope selectable at issuance ([fbb0fb9](https://github.com/AnoRebel/licensing/commit/fbb0fb992bac8245bb579c80c7916903e4eb12e6))
* **sdk:** record seat liveness and add an inactivity sweep ([80a3eab](https://github.com/AnoRebel/licensing/commit/80a3eab4cd06bc75d6fc13cf2364929a50429954))
* **sdk:** split audit attribution into actor_kind and actor_id ([3d6259c](https://github.com/AnoRebel/licensing/commit/3d6259c9651738fbdb2ed21bea3883bbdd67fc8d))
...
* **admin:** add the activity page to the primary nav ([9657db1](https://github.com/AnoRebel/licensing/commit/9657db1f5bd32dbdf257a80f8bdd3c1202f5cb5e))
...
* **admin:** install eslint so `bun run lint` works ([3cc64e5](https://github.com/AnoRebel/licensing/commit/3cc64e562a8d0563f67aed2c263ef3305386a9cb))
* **admin:** migrate DataTable to TanStack Table v9 ([c856c46](https://github.com/AnoRebel/licensing/commit/c856c46d2514d8ac4b8895cf2c13f15f94642a33))
* **admin:** restore the open-fetch client baseURL ([94b46e5](https://github.com/AnoRebel/licensing/commit/94b46e5948c8fc8a510073689247657d0ba297fc))
...
* **admin:** self-host JetBrains Mono to unblock the build ([bf61e71](https://github.com/AnoRebel/licensing/commit/bf61e7195c869753694b82387f84d6df51ccf3cc))
...
* **go-sdk:** let the device client validate either token format ([745a8ce](https://github.com/AnoRebel/licensing/commit/745a8ceebdeaa5d89f85c8f7aa6ab8d95286caf9))
...
* **go:** give default kids randomness and match the TS formula ([a634cf5](https://github.com/AnoRebel/licensing/commit/a634cf52773b4d000e924564f19612fb2f043237))
* **http:** share one pinned clock between test harness and storage ([ee258ae](https://github.com/AnoRebel/licensing/commit/ee258aea641c6ee7f4822f072a476d29b3496417))
* **interop:** sign through the shipped encoder, not a copy of it ([5af5cc6](https://github.com/AnoRebel/licensing/commit/5af5cc661619e17901c12fa639838734de25afc5))
* let a LIC2 server accept its own tokens, and record the issued format ([264b925](https://github.com/AnoRebel/licensing/commit/264b9258e782d4d9a2c33a4bae9b08c2dbe11ecf))
...
* make the operator surfaces aware of LIC2 ([ad63c50](https://github.com/AnoRebel/licensing/commit/ad63c503da0b82332803caa3674d5d419377c121))
...
* **sdk:** key the trial fingerprint hash with HMAC instead of a prefix-MAC ([386faa1](https://github.com/AnoRebel/licensing/commit/386faa12476e25f8d34935370a93413e05181862))
...
* **ts-sdk:** register the LIC2 codec on the device-side client path ([bee9b45](https://github.com/AnoRebel/licensing/commit/bee9b45e78e802eb314fc19f1be69d2dd6a37b3e))
* **ts-sdk:** reject Client config without a serverUrl ([68d5337](https://github.com/AnoRebel/licensing/commit/68d5337a25eca1bac666f90f31a5b7884bcabd10))
* **ts-sdk:** reject symmetric algorithms in the key hierarchy ([7c7bb9d](https://github.com/AnoRebel/licensing/commit/7c7bb9d055f8c42ec36a6c146221c0ae44ca6e29))
...
* **go-sdk:** route token parsing through a codec registry ([f706f68](https://github.com/AnoRebel/licensing/commit/f706f68131ac0ac1e076081aab0e25175f4926c3))
* **ts-sdk:** route token parsing through a codec registry ([e0ec903](https://github.com/AnoRebel/licensing/commit/e0ec903b3c3ec42b9760f2b23273e2a26634dbec))
...
* cover the v9 table conventions and refresh pinned versions ([6bbc1e7](https://github.com/AnoRebel/licensing/commit/6bbc1e7d3683c0a201ca22af9c5195fbaece5527))
...
* fix example output field and stale run commands ([2e1b458](https://github.com/AnoRebel/licensing/commit/2e1b458f3660411596f019b5b45ddf7f8f1adbfa))
...
* specify LIC2, add a stability policy, and guard against version rot ([9c13f1c](https://github.com/AnoRebel/licensing/commit/9c13f1cdb679bf906a81a4471edece3d237261f3))
