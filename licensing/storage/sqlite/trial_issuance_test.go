...
func freshSqliteTemplate(t *testing.T, s *sqlite.Storage, name string) string {
	t.Helper()
...
func TestSqlite_TrialIssuance_RecordAndFind(t *testing.T) {
	s := freshSqlite(t)
	tmpl := freshSqliteTemplate(t, s, "t1")
...
func TestSqlite_TrialIssuance_RejectsDuplicate(t *testing.T) {
	s := freshSqlite(t)
	tmpl := freshSqliteTemplate(t, s, "t1")
...
func TestSqlite_TrialIssuance_NullTemplateGroup(t *testing.T) {
	s := freshSqlite(t)
...
func TestSqlite_TrialIssuance_DeleteFreesSlot(t *testing.T) {
	s := freshSqlite(t)
	tmpl := freshSqliteTemplate(t, s, "t1")
