  ...
  >
    ...
    >
      <slot v-bind="slotProps">
        <!-- Indeterminate (some-but-not-all selected) renders a horizontal
             line via lucide's `Minus`; checked renders the canonical tick.
             Unchecked has no indicator child. -->
